...
import { GetMovieDetailsParams, GetMoviesParams, MovieDetailsTypes, MovieStaffTypes, ResponseListType } from '../types/types'
...
export const moviesApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getMovies: builder.query<ResponseListType, GetMoviesParams>({
